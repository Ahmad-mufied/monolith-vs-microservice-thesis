...
| `VULTR_KUBERNETES_VERSION` | `v1.36.1+3` | VKE Terraform | Mandatorily required. Verified and dynamically updated to the closest supported patch version by the render-tfvars script. |
