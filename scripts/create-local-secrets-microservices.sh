...
api_gateway_diagnostic_logging_enabled="$(read_env_value env/api-gateway.env DIAGNOSTIC_LOGGING_ENABLED)"
...
auth_diagnostic_logging_enabled="$(read_env_value env/auth-service.env DIAGNOSTIC_LOGGING_ENABLED)"
...
item_diagnostic_logging_enabled="$(read_env_value env/item-service.env DIAGNOSTIC_LOGGING_ENABLED)"
