...
if [ ! -f "$env_file" ]; then
  {
    ...
    format_env_assignment "VULTR_APP_NODE_PLAN" "voc-c-16c-32gb-300s"
    format_env_assignment "VULTR_TESTING_NODE_PLAN" "vc2-4c-8gb"
    format_env_assignment "VULTR_POSTGRES_PLAN" "vc2-4c-8gb"
