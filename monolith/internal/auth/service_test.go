...
func TestServiceLogin(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "repo deadline exceeded", req: LoginRequest{Email: "mufied@example.com", Password: "secret123"}, repo: &fakeRepo{findErr: apperror.DeadlineExceeded("request timeout", context.DeadlineExceeded)}, hasher: fakeHasher{}, signer: fakeSigner{}, wantError: true, wantCode: apperror.CodeServiceUnavailable},
